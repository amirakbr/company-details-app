function LeftSide({companylist , handleEdit , handleDelete}) {
     let listShow = companylist.map((index,id)=> index.Name.length >= 1 ? 
     <tr key={id} id={id} className="border-t-2 
     ...
     <td className="md:py-3 md:px-6 text-[1.04rem]
          ...
          break-all before:block before:md:hidden
          before:content-['NAME_:'] before:md:py-[0]
          before:py-[.5rem] 
          flex items-baseline gap-[1rem] md:table-cell
          before:text-[1.08rem] 
          before:font-semibold before:text-secondary" title={'Company Name : ' + " " + index.Name} > {index.Name} </td>
     <td className="md:py-3 md:px-2 md:pr-6 
          text-[1.04rem] font-semibold 
          text-primary md:truncate 
          md:max-w-[3.5rem] break-all
          before:block before:md:hidden
          before:content-['STATE_:'] before:md:py-[0]
          before:py-[.5rem] 
          flex items-baseline gap-[1rem] md:table-cell
          before:text-[1.08rem] 
          before:font-semibold before:text-secondary"
          title={'Company Name : ' + " " + index.State}> {index.State} </td>
     <td className="md:py-3 md:px-2 text-[1.04rem]
          font-semibold text-primary
          md:truncate md:max-w-[2rem] break-all
          before:block before:md:hidden
          before:content-['EMPLOYEEs_:'] before:md:py-[0]
          before:py-[.5rem] 
          flex items-baseline gap-[1rem] md:table-cell
          before:text-[1.08rem] 
          before:font-semibold before:text-secondary" 
     ...
     <td className="flex gap-6 items-center
          ...
          py-[1rem]"> 
          <div id={id} onClick={(event) => handleEdit(event.target.id)}>
          ...
          <div id={id} className="mt-[.2rem]" onClick={(event) => handleDelete(event.target.id)}>
